...
function Card({ className, ...props }: React.ComponentProps<"div">) {
	return (
		<div
			className={cn(
				"relative w-full max-w-xs rounded-xl border border-orange-500 bg-white p-1",
				className
			)}
			{...props}
		/>
...
function Description({ className, ...props }: React.ComponentProps<"p">) {
	return (
		<p className={cn("text-orange-500", className)} {...props} />
	);
}
...
function MainPrice({ className, ...props }: React.ComponentProps<"span">) {
	return (
		<span
			className={cn("font-medium text-xl text-orange-500", className)}
			{...props}
		/>
	);
}
