    ...
    return (
        <section id="services" className='bg-white px-4 md:px-12 py-16'>
            ...
            >
                ...
                <motion.div
                    variants={{ hidden: { x: -60, opacity: 0 }, show: { x: 0, opacity: 1, transition: { duration: 0.80 } } }}
            ...
            >
                <motion.div
                    variants={{ hidden: { y: 20, opacity: 0 }, show: { y: 0, opacity: 1, transition: { duration: 1.25 } } }}
                    className='grid grid-cols-1 md:grid-cols-2 gap-8 mt-12'
                >
                    <div className='border border-[#FF9330] w-full p-4 rounded-lg  gap-6 flex flex-col hover:bg-[#FF9330]/10 transition duration-300'>
            ...
            >
                <motion.div
                    variants={{ hidden: { y: 30, opacity: 0 }, show: { y: 0, opacity: 1, transition: { duration: 1.25 } } }}
