...
const socialLinksData = [
    ...
    {
        name: "LinkedIn",
        url: "https://linkedin.com/in/gauravkr-dev",
    },
    {
        name: "Discord",
    ...
    {
        name: "LeetCode",
        url: "https://leetcode.com/u/gauravkr-dev/",
    }
]
            ...
            {socialLinksData.map((link, index) => (
                <Tooltip key={index}>
                    <TooltipTrigger asChild>
                        <a href={link.url} target="_blank" rel="noopener noreferrer" className="text-foreground hover:text-muted-foreground transition-colors border border-border rounded-lg p-2">
                            {
                                link.name === "GitHub" && (
