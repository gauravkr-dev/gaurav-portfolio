            ...
            {socialLinksData.map((link, index) => (
                <Tooltip key={index}>
                    <TooltipTrigger asChild>
                        <Link href={link.url} target="_blank" rel="noopener noreferrer" className="text-foreground hover:text-muted-foreground transition-colors border border-neutral-400/60 dark:border-border rounded-lg p-2">
                            {link.svg}
                        </Link>
                    </TooltipTrigger>
                    <TooltipContent>
