    ...
    return (
        <section id="home">
            <div className="mt-28 flex items-center justify-start gap-3">
                ...
                <div >
                    <h1 className="text-3xl font-semibold text-foreground flex items-center gap-1">
                        Gaurav Kumar
                        <span className="text-orange-500 mt-1" title="Verified Developer">
            ...
            <div className="mt-8 grid grid-cols-2 md:grid-cols-4 gap-4">
                {
                    stats.map((stat) => (
                        <div key={stat.label} className="flex flex-col items-start border border-neutral-400/60 dark:border-border rounded-lg p-4 gap-1">
