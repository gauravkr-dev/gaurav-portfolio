...
const Navbar = () => {
    ...
    return (
        <div className={`fixed top-0 left-0 right-0 z-50 w-full mx-auto ${scrolled ? ' backdrop-blur-sm' : ''}`}>
            <div className="flex items-center justify-between py-3 max-w-4xl mx-auto px-3">
